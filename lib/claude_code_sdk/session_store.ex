defmodule ClaudeCodeSDK.SessionStore do
  ...
  """
  @spec save_session(String.t(), [ClaudeCodeSDK.Message.t()], keyword()) :: :ok | {:error, term()}
  ...
  def init(opts) do
    storage_dir =
      Keyword.get(
        opts,
        :storage_dir,
        Application.get_env(:claude_code_sdk, :session_storage_dir, @default_storage_dir)
      )
  ...
  defp build_metadata(session_id, messages, opts) do
    %{
      ...
      total_cost: ClaudeCodeSDK.Session.calculate_cost(messages),
